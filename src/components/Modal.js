        ...
        {cover ? (
          <Box
            ...
            sx={{
              objectFit: "cover",
              width: "100%",
              height: { lg: "33%", md: "25%", sm: "22%", xs: "22%" },
            }}
          />
        ) : (
        ...
        <Box ml={4} mr={4} mt={1} display="flex" flexDirection="column">
          ...
          <Box display="flex" mt={1.5}>
            <Button
              variant="contained"
              size="large"
              onClick={() => router.push("/watch/" + firstEpisodeId)}
            >
              <PlayCircle sx={{ mr: 0.5 }} /> Watch Episode 1
            </Button>
            <Button
              variant="outlined"
              size="large"
          ...
          <Typography
            ...
            sx={{
              display: "-webkit-box",
              WebkitBoxOrient: "vertical",
              WebkitLineClamp: utils.showMore(isShowMore),
              overflow: "hidden",
            }}
          >
            {description}
          ...
          >
            Show {utils.moreOrLess(isShowMore)}
          </Button>
          <Typography
            variant="h6"
            color="whitesmoke"
          ...
          <Box display="flex">
            <Typography fontFamily="Nunito" color="grey" mx={2} mt={1}>
              Genres:{" "}
            </Typography>
            {genres && (
          ...
          <Box display="flex">
            <Typography fontFamily="Nunito" color="grey" ml={2}>
              Average Episode:{" "}
            </Typography>
            <Typography fontFamily="Nunito" color="whitesmoke" ml={0.5}>
              {averageEpisode}
            </Typography>
          </Box>
          <Box display="flex">
            <Typography fontFamily="Nunito" color="grey" ml={2} mb={3}>
              Rating:{" "}
            </Typography>
            {rating != null ? (
              <Typography
                fontFamily="Nunito"
                color={utils.changeRatingColor(rating)}
                ml={0.5}
              >
                {rating}%
              </Typography>
            ) : (
              <Typography fontFamily="Nunito" color="silver" ml={0.5}>
                N/A
              </Typography>
            )}
          </Box>
